...
_kmq.push(['trackClick', '.download-billows', 'Downloaded Billows Template']);
_kmq.push(['trackClick', '.download-cirrus', 'Downloaded Cirrus Template']);
_kmq.push(['trackClick', '.download-nimbus', 'Downloaded Nimbus Template']);
